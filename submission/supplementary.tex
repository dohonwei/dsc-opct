...
\small
\resizebox{\textwidth}{!}{\input{tables/table_faced_post_access_dose.tex}}
\end{table*}
...
\centering
\small
\resizebox{\textwidth}{!}{\input{tables/table_v11_strong_calibration_low_label.tex}}
\end{minipage}
\end{center}
...
\centering
\small
\resizebox{\textwidth}{!}{\input{tables/table_v11_crossfit_paired_inference.tex}}
\end{minipage}
\end{center}
...
\centering
\small
\resizebox{\textwidth}{!}{\input{tables/table_v11_leave_one_component.tex}}
\end{minipage}
\end{center}
...
\centering
\small
\resizebox{\textwidth}{!}{\input{tables/table_v11_distribution_coverage_diagnostic.tex}}
\end{minipage}
\end{center}
...
\centering
\small
\resizebox{\textwidth}{!}{\input{tables/table_v12_multidomain_robustness.tex}}
\end{minipage}
\end{center}
...
\input{tables/table_v11_independence_ladder.tex}
...
The previously frozen reproducibility inventory contains 252 files and passed 23/23 checks. The consolidated reviewer-closure validator passed 14/14 checks. The release-readiness driver passed 6/6 gates, including the fail-closed external-arrival detector, whose own validation passed 7/7. AMIGOS and Emognition remained blocked by external data access. The new EKM-ED artifacts will enter the next non-overwriting inventory and submission package; their existence does not convert structural non-estimability into effectiveness or future-domain non-harm evidence.
