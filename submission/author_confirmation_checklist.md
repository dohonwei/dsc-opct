...
- [x] **公开代码入口**：已发布校验归档、源代码、聚合结果和验证报告；v25 更新同步了最终论文 PDF、264-file 复现清单和打包脚本。远端 main、SHA-256 旁车文件与上传归档须保持一致。入口：https://github.com/dohonwei/dsc-opct。
## 已由原始记录核验
...
- [x] 主文 PDF 与补充 PDF 均由当前源文件重新编译，并收入 v25 包，而不是旧快照。
