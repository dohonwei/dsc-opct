...
EXPECTED_FIXED_PATH_GROUPS = {
    ...
    "scripts/make_dcs_opct_v25_submission_artifacts.py": "public_repository_finalization",
    "scripts/validate_dcs_opct_v25_submission_artifacts.py": "public_repository_finalization",
