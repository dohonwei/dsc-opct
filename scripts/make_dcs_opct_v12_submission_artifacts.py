...
EXTRA_SOURCES = {
    ...
    "v12_artifact_builder.py": "scripts/make_dcs_opct_v12_multidomain_artifacts.py",
    "v12_artifact_validator.py": "scripts/validate_dcs_opct_v12_multidomain_artifacts.py",
    "v12_package_builder.py": "scripts/make_dcs_opct_v12_submission_artifacts.py",
    "v12_package_validator.py": "scripts/validate_dcs_opct_v12_submission_artifacts.py",
    ...
    "v12_fig_multidomain_robustness.pdf": "outputs/dcs_opct_v12_multidomain_artifacts_v2/fig_v12_multidomain_robustness.pdf",
    "v12_fig_multidomain_robustness.png": "outputs/dcs_opct_v12_multidomain_artifacts_v2/fig_v12_multidomain_robustness.png",
    "v12_table_multidomain_robustness.tex": "outputs/dcs_opct_v12_multidomain_artifacts_v2/table_v12_multidomain_robustness.tex",
    "v12_artifact_summary.json": "outputs/dcs_opct_v12_multidomain_artifacts_v2/summary.json",
    "v12_artifact_manifest.json": "outputs/dcs_opct_v12_multidomain_artifacts_v2/manifest.json",
    "v12_artifact_independent_validation_report.json": "outputs/dcs_opct_v12_multidomain_artifacts_v2/independent_validation_report.json",
...
def main() -> None:
    if OUT.exists():
        raise FileExistsError(f"Immutable v12 package already exists: {OUT}")
    ...
    progress = tqdm(sorted(sources.items()), desc="Package DCS-OPCT v12 evidence", unit="file", dynamic_ncols=True)
    ...
    print(f"DCS-OPCT v12 submission package built: {len(output_hashes)} evidence files")
    print(f"Package: {OUT}")
